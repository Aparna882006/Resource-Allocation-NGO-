...
function saveAndRedirect(role, email, uid) {
  ...
  const redirects = {
  ngo: "dashboards Pages/ngo-dashboard.html",
  volunteer: "dashboards Pages/volunteer-dashboard.html",
  citizen: "dashboards Pages/citizen-dashboard.html",
  emergency: "dashboards Pages/citizen-dashboard.html"
};
  setTimeout(() => {
    window.location.href = redirects[r] || "Register/mainreg.html";
  }, 700);
}
